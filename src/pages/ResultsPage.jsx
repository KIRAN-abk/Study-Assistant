  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl anim-fade-in">
        ...
        {/* ── Study-set banner ───────────────────────────── */}
        <div className="mb-8 overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-violet-100/50 via-white to-cyan-100/50 p-5 shadow-xl shadow-black/5 dark:border-white/[0.06] dark:from-violet-600/20 dark:via-gray-900 dark:to-cyan-600/10 dark:shadow-2xl dark:shadow-black/40 sm:p-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0 flex-1">
              ...
              <h1 className="mb-4 font-['Plus_Jakarta_Sans',sans-serif] text-xl font-extrabold leading-snug text-gray-900 dark:text-white sm:text-3xl">
                {title}
              </h1>
              ...
              >
                <span className="flex items-center gap-1.5">
                  ...
                  <strong className="font-semibold text-gray-900 dark:text-white">{flashcards.length}</strong>
                  &nbsp;flashcards
                </span>
                <span className="h-3.5 w-px bg-gray-300 dark:bg-gray-700" aria-hidden="true" />
                <span className="flex items-center gap-1.5">
                  <span aria-hidden="true">🧠</span>
                  <strong className="font-semibold text-gray-900 dark:text-white">{quiz.length}</strong>
                  &nbsp;quiz questions
                </span>
              </div>
            </div>
            ...
            <button
              onClick={onBack}
              className="touch-target self-start inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-600 transition-all hover:border-gray-300 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 dark:border-gray-700 dark:bg-gray-900/80 dark:text-gray-400 dark:hover:border-gray-600 dark:hover:text-white"
        ...
        {/* ── Tab switcher ────────────────────────────────── */}
        <div
          className="mb-8 flex gap-1.5 overflow-x-auto rounded-xl border border-gray-200 bg-gray-100 p-1.5 w-fit max-w-full dark:border-gray-800 dark:bg-gray-900"
          role="tablist"
            ...
            return (
              <button
                ...
                className={`flex flex-shrink-0 items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 ${
                  isActive
                    ? "bg-white text-violet-700 shadow shadow-black/10 dark:bg-violet-600 dark:text-white dark:shadow-lg dark:shadow-violet-600/30"
              ...
              >
                ...
                <span
                  className={`rounded-full px-2 py-0.5 text-[11px] font-bold ${
                    isActive ? "bg-violet-100 text-violet-700 dark:bg-white/20 dark:text-white" : "bg-gray-200 text-gray-500 dark:bg-gray-800"
                  }`}
